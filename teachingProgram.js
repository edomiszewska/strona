...
const teachingProgram = [
  ...
  {
    name: "Montaż, naprawa, konserwacja i obsługa sprzętu komputerowego",
    topic: [
  ...
  {
    name: "Tworzenie aplikacji internetowych",
    topic: [
...
const select = document.querySelector(`#temat`);
